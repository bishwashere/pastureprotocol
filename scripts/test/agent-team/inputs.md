...
| Delegate by specialization (not agent name) | `scripts/test/e2e/real/agent/test-agent-team-e2e.js` (natural chat + real `agent-send`) |
| Remove / re-add alex link | `scripts/test/e2e/real/agent/test-agent-team-e2e.js` |
...
| New session ack | `scripts/test/e2e/real/agent/test-agent-team-e2e.js` + `scripts/test/unit/core/test-chat-session.js` |
