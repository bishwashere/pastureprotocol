...
export function buildMissionTickPrompt(mission, opts = {}) {
  ...
  return [
    ...
    '  // "waiting_user" — agent asked user a question; task resumes when user replies.',
    '  // "blocked" — ONLY for: user input required to unlock, missing external access/credentials, or a hard error. NOT for normal incomplete work.',
    '  // "review_ready" — output ready for lead/user review.',
