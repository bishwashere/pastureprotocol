...
import { getGithubSystemPromptBlock } from './github-context.js';
import { buildUserReplyStyleBlock } from './user-reply-style.js';
...
export function buildOneOnOneSystemPrompt(workspaceDir) {
  ...
  return soulContent + identityBlock + getGithubSystemPromptBlock() + buildLessonsBlock(dir) + buildUserReplyStyleBlock() + timeBlock;
}
