...
import { resolveSharedTurnHistory } from './conversation-context.js';
...
export async function runInternalAgentTurn({
  ...
  const ctx = {
    ...
    callerAgentId,
    delegationHistoryMessages: Array.isArray(sharedHistoryMessages) && sharedHistoryMessages.length
