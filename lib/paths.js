...
/** Persistent goals store used by goal engine + dashboard. */
export function getGoalsStorePath() {
  return join(getStateDir(), 'goals', 'goals.json');
}

/** Persistent initiatives store used by proactive initiative system. */
export function getInitiativesStorePath() {
...
export function getCuriosityMomentumStatePath() {
  return join(getStateDir(), 'goals', 'curiosity-momentum.json');
}
...
export function ensureStateDir() {
  ...
  const goalsDir = join(getStateDir(), 'goals');
