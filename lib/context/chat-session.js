...
// to start work / collaborate with the team. Detection is LLM-driven — see
// lib/agent/intent-planner.js (workModeToggle field). No regex, no keyword
// markers; the same model that handles the turn classifies the toggle.
