 ...
 */
export function getMissionsDiscoveryIntentHint(userText, historyMessages, enabledSkillIds, agentId = 'main', opts = {}) {
  if (!opts.forceDiscovery && !isWorkOrDiscoveryRequest(userText)) return null;
