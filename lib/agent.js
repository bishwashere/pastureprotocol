...
import { onAgentTurnStart, onAgentSkillStart, onAgentTurnDone } from './agent-context-state.js';
...
export async function runAgentTurn({
  ...
  if (useAgentSendAsReply) {
    const label = agentSendResult.agentTitle || agentSendResult.agent || 'agent';
    textToSend = withPrefix(`${label} replied: ${agentReplyText}`);
