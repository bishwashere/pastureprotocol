        ...
        const probeReply = await llmChat([
          ...
          },
          {
            ...
            content:
              ...
              `If the user only stated a goal (e.g. "increase sign ups") and did not approve creation, do NOT list "create mission" or "create tasks on dashboard" as missing — treat planning as done and approval as pending.\n` +
