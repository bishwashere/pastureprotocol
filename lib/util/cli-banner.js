...
const THEME_CYAN = '\x1b[36m';
const ANSI_RESET = '\x1b[0m';

export const CLI_BANNER = `${THEME_CYAN}${BANNER_LINES.join('\n')}${ANSI_RESET}`;
...
/** Env for nested `cli.js` invocations that are part of the current user action (e.g. update → dashboard). */
