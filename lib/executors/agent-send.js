...
export async function executeAgentSend(ctx, args = {}) {
  ...
  try {
    ...
    onAgentWaitingFor({
      ...
      targetAgentId,
      task: message,
      targetGoal: /blog|marketing|content|campaign|ad\b|newsletter|seo|social/i.test(message)
    ...
    onAgentDelegationDone({ callerAgentId, targetAgentId });
    ...
    onAgentDelegationError({ callerAgentId, targetAgentId });
