/**
 * User-facing reply style — injected once per chat/delegation turn, not in SOUL.md or mission/project blocks.
 */
...
export const USER_REPLY_STYLE_LINES = [
  ...
  'Do not say you "investigated end-to-end" unless you have substantive findings; never list the Pasture workspace folder contents unless the user asked where files are.',
...
/** Single line for the post-turn completeness probe (not duplicated in missions/projects). */
