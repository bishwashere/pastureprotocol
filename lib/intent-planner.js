 ...
 *
 * @param {{ userText: string, availableSkillIds?: string[], availableSkillSummaries?: Array<{id:string,description:string}>, agentId?: string }} opts
 ...
 */
export async function planIntent({ userText, availableSkillIds = [], availableSkillSummaries, agentId }) {
