/**
 * Core skill: run allowlisted shell commands (ls, cd, pwd, cat, less, du, cp, mv, rm, touch, chmod, mkdir).
...
const ALLOWED = new Set(['ls', 'cd', 'pwd', 'cat', 'less', 'du', 'cp', 'mv', 'rm', 'touch', 'chmod', 'mkdir', 'rsync']);
