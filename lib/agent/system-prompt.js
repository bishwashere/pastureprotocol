...
// Runtime grounding: kept as an exported constant so tests and the cron
// executor can reuse the exact same wording. The daemon runs on the user's
// own machine — localhost is reachable, network sandbox excuses are wrong.
