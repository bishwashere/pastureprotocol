...
const FINAL_REPLY_POLICY_MD = 'final-reply-policy.md';
...
export const FINAL_REPLY_POLICY_BLOCK = '\n\n' + readTemplateMd(FINAL_REPLY_POLICY_MD);
 ...
 * @returns {string}
 */
export function buildOneOnOneSystemPrompt(workspaceDir, options = {}) {
  ...
  return soulContent + identityBlock + RUNTIME_GROUNDING_BLOCK + FINAL_REPLY_POLICY_BLOCK + getGithubSystemPromptBlock() + buildLessonsBlock(dir) + timeBlock;
}
