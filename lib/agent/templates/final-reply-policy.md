...
- When a durable task worklog is present, use all of its checkpoints during synthesis so the final answer includes relevant early and late results. Newer direct tool evidence overrides an older checkpoint if they conflict.
