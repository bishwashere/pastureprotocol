import { TASK_LABELS, BLOCKER_TYPES } from '../../context/tasks.js';
    ...
    blockers: [
      {
        ...
        blockerType: BLOCKER_TYPES.NEED_DIRECTION,
      },
      {
        id: 'product-data',
        ...
        blockerType: BLOCKER_TYPES.NEED_ACCESS,
      },
      {
        id: 'analytics',
      ...
      },
      {
        ...
        blockerType: BLOCKER_TYPES.NEED_CONTENT,
      },
    ],
  },
  {
...
export function inferBlockerTemplateTasks(input = {}) {
  ...
  const tasks = template.blockers
    ...
    .map((blocker) => ({
      ...
      title: blocker.title,
      status: 'blocked',
      blockerType: blocker.blockerType || 'need_direction',
      progress: 0,
      assignee: 'user',
